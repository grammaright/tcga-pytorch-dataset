...
#     gene_list = list(pd.read_excel("./pan_cancer.xlsx", header = None, index_col = False)[0])
    gene_list = list(pd.read_csv("./pan_cancer.txt", header = None, index_col = False)[0])
...
#     tcga_base = '/home/grammaright/Downloads/tcga'
    ...
    test_dataset = MountGeneExpressionDataset(tcga_base, test_data, label_column, gene_list)
#     train_dataset = NaiveMountGeneExpressionDataset(tcga_base, train_data, label_column, gene_list)
#     test_dataset = NaiveMountGeneExpressionDataset(tcga_base, train_data, label_column, gene_list)
